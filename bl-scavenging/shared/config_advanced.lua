...
Config.ExitConcealmentAnim = true -- If true, the player will play an animation when they leave the dumpster.

Config.VagrantJobRole = "hobo"

Config.CapCurrencyItem = "bottle_cap"  -- Custom Bottle Cap Item

Config.ReleaseTrolleyKey = "X" -- Key to leave the cart when riding, also changable in Keybinds

Config.DisableProgressionFeatures = false -- NEW IN 2.2.0 - If true, this will keep the script as a simple Dumpster Searching system, similar to V1

Config.ProgressionSettings = {
    ...
    -- XP
    XPPerCapTributed = 2, -- XP gained per bottle cap donated
...
Config.StreetWarden = {
    ...
    InactivityDays = 7,                                         -- Days before Hobo King position is stripped from the current player
...
Config.PanhandleSettings = {
    PanhandleCommand = "beg",
...
Config.VerminBaitDuration = 60 -- Seconds
...
Config.SalvageTable = {
    Items = {
        ...
        common = {
            chance = 50,
            items = {
                { name = Config.CapCurrencyItem,  amount = { 1, 1 }, chance = 20 }, -- needed for progression
        ...
        uncommon = {
            chance = 35,
            items = {
                { name = Config.CapCurrencyItem,      amount = { 1, 2 }, chance = 20 },
        ...
        rare = {
            chance = 25,
            items = {
                { name = Config.CapCurrencyItem,      amount = { 2, 3 }, chance = 50 }, -- needed for progression
        ...
        very_rare = {
            chance = 15,
            items = {
                { name = Config.CapCurrencyItem,    amount = { 3, 4 }, chance = 40 }, -- needed for progression
...
Config.ReclaimExchangeRates = {
    [Config.CapCurrencyItem] = {
        material = "metalscrap",
        min = 1,
        max = 3,
    },
